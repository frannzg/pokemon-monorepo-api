...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'API pública para consultar, crear, editar y eliminar Pokémon y equipos. Datos sincronizados desde PokeAPI.',
      ...
      schemas: {
        Pokemon: {
          ...
          properties: {
            ...
            id: {
              type: 'string',
              description: 'ID único del Pokémon (1-1010 de PokeAPI, ≥100000 custom)',
            },
            name: { type: 'string', description: 'Nombre del Pokémon' },
            types: {
              type: 'string',
              description: 'Tipos separados por coma (e.g. "fire, flying")',
            },
            rawData: {
              type: 'object',
              description: 'Respuesta completa de PokeAPI',
            },
          ...
          example: {
            ...
            rawData: {
              ...
              sprites: {
                other: {
                  'official-artwork': { front_default: 'https://...' },
                },
              },
            },
          },
    ...
    paths: {
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              in: 'query',
              schema: { type: 'string' },
              description: 'Filtrar por IDs específicos, separados por coma',
            },
            { name: 'page', in: 'query', schema: { type: 'integer', default: 1 } },
            {
              name: 'limit',
              in: 'query',
              schema: { type: 'integer', default: 60, maximum: 200 },
            },
            {
              name: 'sort',
              in: 'query',
              schema: { type: 'string', enum: ['id', 'name'] },
              description: 'Ordenar por # o nombre',
            },
          ],
          responses: {
            200: {
      ...
      '/api/pokemon/random': {
        get: {
          ...
          responses: {
            ...
            404: { description: 'No hay Pokémon disponibles' },
          },
        },
      },
      '/api/pokemon/{id}': {
          ...
          parameters: [
            {
              ...
              required: true,
              schema: { type: 'string' },
              description: 'ID numérico o nombre del Pokémon',
            },
          ],
          responses: {
            200: {
              description: 'Detalle del Pokémon con prevPokemon/nextPokemon',
              content: {
                'application/json': {
                  schema: {
                    type: 'object',
                    properties: {
                      prevPokemon: { type: 'object' },
                      nextPokemon: { type: 'object' },
                    },
                    allOf: [{ $ref: '#/components/schemas/Pokemon' }],
                  },
                },
              },
            },
        ...
        put: {
          ...
          responses: {
            200: { description: 'Pokémon actualizado' },
            404: { description: 'Pokemon not found' },
          },
        },
        delete: {
      ...
      '/api/pokemon/{id}/species': {
        get: {
          ...
          responses: {
            200: { description: 'Species data from PokeAPI' },
            404: { description: 'Species data not available' },
          },
        },
      },
      '/api/pokemon/{id}/evolution': {
        get: {
          ...
          responses: {
            200: { description: 'Evolution chain from PokeAPI' },
            404: { description: 'Evolution chain not available' },
          },
        },
      },
      '/api/pokemon/sync': {
      ...
      '/api/teams': {
        ...
        post: {
          ...
          responses: {
            ...
            400: { description: 'Team cannot have more than 6 Pokémon' },
          },
        },
      },
      '/api/teams/{id}': {
